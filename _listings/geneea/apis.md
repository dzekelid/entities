...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/entities/master/_listings/geneea/apis.md
...
- name: Geneea Natural Language Processing Get Entities
  ...
  baseURL: https://api.geneea.com////s1/entities
  tags: Entities
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/entities/master/_listings/geneea/s1entities-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/entities/master/_listings/geneea/s1entities-get-openapi.md
- name: Geneea Natural Language Processing Post Entities
  x-api-slug: geneea-natural-language-processing
  description: Performs named-entity recognition on the given document.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/geneea-logo.png
  humanURL: https://www.geneea.com
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/entities/master/_listings/geneea/s1entities-post-openapi.md
- name: Geneea Natural Language Processing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/entities/master/_listings/geneea/openapi.md
x-common:
- type: x-website
